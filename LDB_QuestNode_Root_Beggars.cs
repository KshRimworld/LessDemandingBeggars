...
namespace LDB
{
    public class LDB_QuestNode_Root_Beggars : QuestNode
    {
        ...
        private const float BeggarRequestValueFactor = 0.55f;
        ...
        {
            return Mathf.Min(points * LDB_Settings.BeggarRequestValueFactor, LDB_Settings.MaxRequestValue);
        }
